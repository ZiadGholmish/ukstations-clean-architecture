...
fun StopPointEntity.toStopPoint(): StopPoint {
    return StopPoint(this.commonName, this.distance, this.lat, this.lon, listOf())
}

fun ArrivalTimeEntity.toArrivalTime(): ArrivalTimeModel {
    return ArrivalTimeModel(this.lineName, this.destinationName, this.timeToStation, this.expectedArrival)
}
