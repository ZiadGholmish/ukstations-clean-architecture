...
import com.ukstations.app.app.AppConstants
import com.ukstations.app.app.UKStationApp
import com.ukstations.app.dagger.ViewModelFactory
...
import com.ukstations.app.presentation.views.nearbystations.adapter.CustomInfoWindowGoogleMap
import com.ukstations.app.presentation.views.nearbystations.adapter.StopPointAdapter
import com.ukstations.app.util.toParcelable
...
class NearbyStationsActivity : AppCompatActivity(), NearbyStationsController, OnMapReadyCallback,
    ...
    private fun setupPresenterAndVM() {
        (application as UKStationApp).appComponent.inject(this)
